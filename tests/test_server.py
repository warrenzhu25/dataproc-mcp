...
from dataproc_mcp_server.server import list_tools, call_tool
...
class TestMCPServer:
    ...
    async def test_call_tool_list_clusters(self):
        ...
        with patch('dataproc_mcp_server.server.DataprocClient') as mock_client_class:
            ...
            mock_client.list_clusters = AsyncMock(return_value={
                "clusters": [],
                "total_count": 0,
            ...
            mock_client.list_clusters.assert_called_once_with("test-project", "us-central1")
