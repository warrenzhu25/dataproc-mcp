    ...
    async def create_batch_job(
        ...
        try:
            ...
            operation = await loop.run_in_executor(
                None, client.create_batch, request
            )
    ...
    async def list_batch_jobs(
        ...
        try:
            ...
            response = await loop.run_in_executor(
                None, client.list_batches, request
            )
                ...
                "state_history": [
                    {
                        ...
                        "state_start_time": state.state_start_time.isoformat() if state.state_start_time else None
                    }
    ...
    async def delete_batch_job(
        ...
        try:
            ...
            await loop.run_in_executor(
                None, client.delete_batch, request
            )
